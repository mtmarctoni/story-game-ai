...
export function GameErrorStatus({ error, onRetry, onDismiss }: GameErrorStatusProps) {
    ...
    <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-6 mb-4 space-y-4">
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-destructive/80 text-sm leading-relaxed">{description}</p>
        </div>
      </div>

      {/* Suggestions */}
      <div className="ml-11 space-y-2">
        <h4 className="text-sm font-medium text-muted-foreground">What you can do:</h4>
